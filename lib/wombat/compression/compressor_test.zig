...
const CompressionError = @import("compressor.zig").CompressionError;
const CompressionStats = @import("compressor.zig").CompressionStats;
const CompressionUtils = @import("compressor.zig").CompressionUtils;
